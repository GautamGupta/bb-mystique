...
<?php if ( !empty ( $q ) ) : ?>
<h3 id="search-for"><?php printf( __( 'Search for %s', 'bb-mystique' ), '&#8220;' . esc_html( $q ) . '&#8221;' ); ?></h3>
<?php endif; ?>

<?php if ( $recent ) : ?>
<div id="results-recent" class="search-results">
	<h4><?php _e( 'Recent Posts', 'bb-mystique' )?></h4>
	<ol>
...
<div id="results-relevant" class="search-results">
	<h4><?php _e( 'Relevant Topics', 'bb-mystique' )?></h4>
	<ol>
...
<ul id="search-suggestions">
	<li><?php _e( 'Make sure all words are spelled correctly', 'bb-mystique' ); ?></li>
	<li><?php _e( 'Try different keywords', 'bb-mystique' ); ?></li>
	<li><?php _e( 'Try more general keywords', 'bb-mystique' ); ?></li>
</ul>
<?php endif; ?>

<br />
<p><?php printf( __( 'You may also try your <a href="%s">search at Google</a>.', 'bb-mystique' ), 'http://google.com/search?q=site:' . bb_get_uri( null, null, BB_URI_CONTEXT_TEXT ) . urlencode( ' ' . $q ) ); ?></p>
