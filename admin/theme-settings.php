...
function mystique_admin_init_js(){
  ...
  $current_settings = get_option('bb-mystique');
  ?>
...
function mystique_update_options() {
  ...
  if(!current_user_can('switch_themes')) wp_die(__('You are not authorised to perform this operation.', 'bb-mystique'));
  ...
  update_option('bb-mystique', $options);
...
function mystique_theme_settings() {
  ...
  <div id="mystique-settings" class="wrap clear-block">
   ...
   <div class="clear-block">
     <?php screen_icon(); ?><h2 class="alignleft"><?php _e('bb Mystique settings','bb-mystique'); ?></h2>
   ...
   <div class="updated fade below-h2">
    <p><?php printf(__('Settings saved. %s', 'bb-mystique'),'<a href="' . user_trailingslashit(get_bloginfo('url')) . '">' . __('View site','bb-mystique') . '</a>'); ?></p>
   </div>
   ...
   <div class="error fade below-h2">
    <p><?php printf(__('Error: %s', 'bb-mystique'),$errors[$_GET['error']]); ?></p>
   </div>
   <?php endif; ?>
    ...
    <div class="sections wrap metabox-holder">
     ...
     <div class="section" id="tab-content">
      <table class="form-table">
       ...
       <tr>
        <th scope="row"><p><?php _e("Footer content","mystique"); ?><span><?php  if(current_user_can('unfiltered_html')) _e("You can post HTML code",'bb-mystique'); else _e("Only some HTML tags and attributes are allowed",'bb-mystique'); ?></span></p></th>
        <td>
   ...
   <div class="support">
    ...
    <a href="http://digitalnature.ro/projects/mystique"><strong>bb Mystique</strong></a> is a free theme designed by <a href="http://digitalnature.ro">digitalnature</a>.<br />You can support the development of more free resources by donating.
   </div>
...
function mystique_add_menu() {
  $page = add_theme_page(
       __('bb Mystique settings', 'bb-mystique'),
       __('bb Mystique settings', 'bb-mystique'),
       'edit_themes',
       'theme-settings',
